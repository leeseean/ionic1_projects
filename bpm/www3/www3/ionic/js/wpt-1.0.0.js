...
wpt.checkPlatform = function()
{
    ...
    if (isAndroid)
    {
       // document.write('<script src="http:\/\/61.145.96.125:8018\/wpt\/scripts\/cordova\/cordova-android.3.5.0.js"><\/script>')
        document.write('<script  src="..\/ionic\/js\/cordova\/cordova-2.3.0.js"><\/script>')

    }
    else
    {
        //document.write('<script src="http:\/\/61.145.96.125:8018\/wpt\/scripts\/cordova\/cordova-ios.3.5.0.js"><\/script>')
        document.write('<script  src="..\/ionic\/js\/cordova\/cordova-ios.3.5.0.js"><\/script>')
    }
}
