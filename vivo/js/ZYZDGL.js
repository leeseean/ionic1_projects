 ...
 */
appMain.controller('ZYZDGLCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    $scope.controlApproval={isCanApproval:true,controlID:"",approvaler:""};
    var selectColumn=all_selectColumn+";sel_Train;divDutyRadio;divConflictRadio;divApproveRadio;divExplicitRadio;divIsRightYesRadio;" +
