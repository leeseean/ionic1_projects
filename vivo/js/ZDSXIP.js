 ...
 */
appMain.controller('ZDSXIPCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var zdsxip_selectColumn = all_selectColumn+";meetingType;txt_FAuthor_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
    var zdsxip_encryptionColumn = "hidVontainer01";
    var param = {
        selectColumn: zdsxip_selectColumn+";"+zdsxip_encryptionColumn,
        encryptionColumnn:zdsxip_encryptionColumn,
        isGetList:false
    };
