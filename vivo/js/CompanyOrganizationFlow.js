 ...
 */
appMain.controller('CompanyOrganizationFlowCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var comDoc_selectColumn = all_selectColumn+";txt_FAuthor_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
    var comDoc_encryptionColumn = "hidVontainer01";
    var param = {
        selectColumn: comDoc_selectColumn+";"+comDoc_encryptionColumn,
        encryptionColumnn:comDoc_encryptionColumn,
        isGetList:false
    };
