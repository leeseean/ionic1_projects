 ...
 */
appMain.controller('TXZYGFCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    $scope.controlApproval={isCanApproval:true,controlID:"",approvaler:""};
    var selectColumn=all_selectColumn+";sel_FIsTrain;divDutyRadio;divConflictRadio;divApproveRadio;divExplicitRadio;divIsRightYesRadio;" +
        "txt_FAuthor_text;txt_FCountersign_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text" +
        ";txt_FTrainAuthor_text;txt_FTrainManager_text;txt_FTrainReaders_text";
    var encryptionColumn = "hidVontainer01;hidVontainer02";
    var param = {
    ...
    linkDatas.getKeyAndForm(param, function (newitem) {
        newitem.divApproveRadio = newitem.divApproveRadio=="ApproveYes"?"是":"否";
        newitem.divConflictRadio = newitem.divConflictRadio=="ConflictYes"?"是":"否";
        newitem.divDutyRadio = newitem.divDutyRadio=="DutyYes"?"是":"否";
        newitem.divExplicitRadio = newitem.divExplicitRadio=="ExplicitYes"?"是":"否";
        newitem.divIsRightYesRadio = newitem.divIsRightYesRadio=="IsRightYes"?"是":"否";
    ...
    $scope.init = function(){
        ...
        for(var i= 0,l=$scope.item.approvalRecord.length;i<l;i++){
            ...
            switch ($scope.item.approvalRecord[i].ApprovalNodeName){
                ...
                case "会签":$scope.item.txt_FCountersign_value=$scope.item.txt_FCountersign_value?$scope.item.txt_FCountersign_value+"<br/>"+val+"；":val+"；";break;
