 ...
 */
appMain.controller('RewardNoticeFlowCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var reward_selectColumn=all_selectColumn+";txt_FRewardUser;ck_FW1;ck_FW2;txt_FAuthor_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
