 ...
 */
appMain.controller('PunishmentNoticeFlowCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var punishmentNotitce_selectCoumn=all_selectColumn+";txt_CF_User;txt_FAuthor_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
    var param = {
        selectColumn: punishmentNotitce_selectCoumn+";hidVontainer01",
