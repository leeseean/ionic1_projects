 ...
 */
appMain.controller('GDZC00Ctrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var selectColumn=all_selectColumn+";sel_companyType;sel_category;sel_dealType;txt_FAssetsAmount;txt_FNetBookAmount;txt_FTakeawayAmount;" +
        "txt_FAuthor_text;txt_FAuditSign_text;txt_FDeptAudit_text;txt_FTechnicalEvaluation_text;txt_TakeawayPrice_text;txt_FPriceReview_text;txt_FAudit_text" +
        ";txt_FieldManager_text;txt_FGeneralManagerAudit_text;txt_FFinancialReceipt_text;txt_FCollectionConfirmation_text;txt_FFinancialAccount_text;txt_FReaders_text";
    ...
    $scope.init = function(){
        ...
        for(var i= 0,l=$scope.item.approvalRecord.length;i<l;i++){
            ...
            switch ($scope.item.approvalRecord[i].ApprovalNodeName){
                ...
                case "审计签收":$scope.item.txt_FAuditSign_value =  val;break;
                case "部门审核":$scope.item.txt_FDeptAudit_value =  val;break;
                case "技术鉴定":$scope.item.txt_FTechnicalEvaluation_value =  val;break;
                case "外卖报价":$scope.item.txt_TakeawayPrice_value =  val;break;
                ...
                case "总经理批准":$scope.item.txt_FGeneralManagerAudit_value =  val;break;
                case "财务签收":$scope.item.txt_FFinancialReceipt_value =  val;break;
                case "收款确认":$scope.item.txt_FCollectionConfirmation_value =  val;break;
                case "财务销账":$scope.item.txt_FFinancialAccount_value =  val;break;
                default:break;
            }
        }
        switch ($scope.item.txt_FDocCurrentStatus){
            case "重新提交":$scope.item.txt_FAuthor_value =  "";break;
            case "审计签收":$scope.item.txt_FAuditSign_value =  "";break;
            case "部门审核":$scope.item.txt_FDeptAudit_value =  "";break;
            case "技术鉴定":$scope.item.txt_FTechnicalEvaluation_value =  "";break;
            case "外卖报价":$scope.item.txt_TakeawayPrice_value =  "";break;
            ...
            case "总经理批准":$scope.item.txt_FGeneralManagerAudit_value =  "";break;
            case "财务签收":$scope.item.txt_FFinancialReceipt_value =  "";break;
            case "收款确认":$scope.item.txt_FCollectionConfirmation_value =  "";break;
            case "财务销账":$scope.item.txt_FFinancialAccount_value =  "";break;
            default:break;
        }
