 ...
 */
appMain.controller('TXBMZDCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var txbmzd_selectColumn = all_selectColumn+";txt_FAuthor_text;txt_FManager_text;txt_FReview_text;txt_FCFGManager_text;txt_FReaders_text";
    var param = {
        selectColumn: txbmzd_selectColumn+";hidVontainer01",
    ...
    $scope.init = function(){
        ...
        for(var i= 0,l=$scope.item.approvalRecord.length;i<l;i++){
            ...
            switch ($scope.item.approvalRecord[i].ApprovalNodeName){
                ...
                case "体系审核":$scope.item.txt_FSysAudit_value =  val;break;
        ...
        switch ($scope.item.txt_FDocCurrentStatus){
            ...
            case "体系审核":$scope.item.txt_FSysAudit_value =  "";break;
