 ...
 */
appMain.controller('LYTDRMCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var lytdrm_selectColumn=all_selectColumn+";txt_FAuthor_text;txt_FSystemTutorship_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
    var lytdrm_encryptionColumn = "hidVontainer01;hidVontainer02;hidVontainer03;hidVontainer04";
    var param = {
        selectColumn: lytdrm_selectColumn+";"+lytdrm_encryptionColumn,
        encryptionColumnn:lytdrm_encryptionColumn,
        isGetList:false
    };
    ...
    $scope.init = function(){
        ...
        for(var i= 0,l=$scope.item.approvalRecord.length;i<l;i++){
            ...
            switch ($scope.item.approvalRecord[i].ApprovalNodeName){
                ...
                case "体系（辅导）":$scope.item.txt_FSystemTutorship_value2 =  val;break;
        ...
        switch ($scope.item.txt_FDocCurrentStatus){
            ...
            case "体系（辅导）":$scope.item.txt_FSystemTutorship_value2 =  "";break;
