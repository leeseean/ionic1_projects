 ...
 */
appMain.controller('SMZZFGCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var smzzfg_selectColumn=all_selectColumn+";txt_FAuthor_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
    var smzzfg_encryptionColumn = "hidVontainer01;hidVontainer02";
    var param = {
        selectColumn: smzzfg_selectColumn+";"+smzzfg_encryptionColumn,
        encryptionColumnn:smzzfg_encryptionColumn,
        isGetList:true,
        lineType:"SMZZFG"
    };
