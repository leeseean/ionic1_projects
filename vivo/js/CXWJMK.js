 ...
 */
appMain.controller('CXWJMKCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    ...
    $scope.init = function(){
        ...
        for(var i= 0,l=$scope.item.approvalRecord.length;i<l;i++){
            ...
            switch ($scope.item.approvalRecord[i].ApprovalNodeName){
                ...
                case "流程审核":$scope.item.txt_FSignAudit_value =  val;break;
                case "审核":$scope.item.txt_FSystemAudit_value =  val;break;
        ...
        switch ($scope.item.txt_FDocCurrentStatus){
            ...
            case "流程审核":$scope.item.txt_FSignAudit_value =  "";break;
            case "审核":$scope.item.txt_FSystemAudit_value =  "";break;
