 ...
 */
appMain.controller('HYJYIPCtrl',function($scope,simplePopUp,approvalFactory,$state,$ionicLoading,linkDatas,bpmCommonFunc) {
    $scope.cnNumber = cnNumber;
    var hyjyip_selectColumn = all_selectColumn+";meetingType;txt_FMeetIngDate;txt_FMeetingDD;txt_FMeetings_text;txt_FAuthor_text;txt_FManager_text;txt_FCFGManager_text;txt_FReaders_text";
    var hyjyip_encryptionColumn = "hidVontainer01";
    var param = {
        selectColumn: hyjyip_selectColumn+";"+hyjyip_encryptionColumn,
        encryptionColumnn:hyjyip_encryptionColumn,
        isGetList:false
    };
