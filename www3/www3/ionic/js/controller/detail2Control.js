...
/*var processInstId = {};*/
ionicApp.controller('detail2Control',function($scope,$http,$stateParams,$window,$state,$ionicGesture,showAlert){
    ...
    $scope.element = angular.element(document.querySelector('#detail2'));
    $scope.events = [{
        event: 'swipeup'
    }, {
        event: 'swipedown'
