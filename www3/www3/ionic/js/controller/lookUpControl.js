...
ionicApp.controller('lookUpControl',function($scope,$http,$state,$stateParams,$window,$timeout,showAlert){
 ...
 $scope.queryPeople=function(){
    ...
    $scope.tagName=[];
    var ALLCOND="";
    var page={begin: 0, length: 2500, isCount: true};
    ...
    $scope.ensure=function(){
        ...
        for(var i=0;i<$scope.tagName.length;i++){
           ...
           if($scope.tagName[i].checked==true){
              ...
              $state.go('pgAuditAdvise3',transdata3);
