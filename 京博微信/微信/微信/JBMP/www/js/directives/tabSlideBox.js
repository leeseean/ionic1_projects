            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    function renderScrollableTabs() {
                        var tabsDiv = angular.element(box.querySelector(".weui_navbar")),
                            tabs = tabsDiv.children(),
